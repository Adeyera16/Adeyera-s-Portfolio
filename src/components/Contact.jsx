    ...
    <div className='bg-black md:px-[5rem] border-t-4 border-gray-700'>
        <div className='flex flex-col justify-center max-w-[50rem] bg-black/25 p-4 '>
            ...
            <form ref={contactForm} onSubmit={sendEmail} className='flex flex-col '>
                <label htmlFor="user_name" className='flex flex-col mt-[1rem] text-white'>
                    Your name:
                ...
                <label htmlFor="user_email" className='flex flex-col mt-[1rem] text-white'>
                    Your email:
                ...
                <label htmlFor="subject" className='flex flex-col text-white mt-[1rem]'>
                    Subject:
                  <input type="text" name='subject' placeholder="Subject" required className='border-2 border-gray-200 rounded-lg p-2 w-[20rem] my-2'/>
                </label>
                <label htmlFor="message" className='flex flex-col mt-[1rem] text-white'>
                    Your message:
                ...
                <button type='submit' className='bg-white text-black w-[10rem] my-4 p-2 rounded-full'>
                    Send Message
                </button>
            </form>
        </div>
